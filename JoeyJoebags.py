...
#Shark MX Cart Menu
        ...
        AM29FMenu = Menu(menu, tearoff=False)
        cartTypeMenu.add_cascade(label='AM29F Flash Cart',menu=AM29FMenu)
        AM29FMenu.add_command(label='Flash ROM',command=main_AM290_Burn_ROM)
...
if dev is not None:
    ...
    messagebox.showinfo("Welcome","Gen3 is a work in progress, This is a custom version, report issues at https://github.com/HDR/JoeyJoebags")
    main_CheckVersion()
